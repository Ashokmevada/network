...
from src.network.entity.config_entity import(
...
from src.network.constant.training_pipeline import TRAINING_BUCKET_NAME
from src.network.cloud.s3_sync import S3Sync
from src.network.constant.training_pipeline import SAVED_MODEL_DIR
import sys
